/**
 * File: LargeCustomerSimulation.java
...
public class LargeCustomerSimulation {
	//main code that creates a simulation 
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int j = 0; j < 1000; j++) {
            Customer cust = new LargeCustomer(1+gen.nextInt(4), 10);
